<?php
	...
	function saveCar ($plate, $color) {
		...
		$stmt = $mysqli->prepare("INSERT INTO car_ans_colors (plate, color) VALUES (?, ?)");
	...
	function deleteCar($id){
 		...
 		$stmt = $mysqli->prepare("UPDATE car_ans_colors SET deleted=NOW() WHERE id=? AND deleted IS NULL");
